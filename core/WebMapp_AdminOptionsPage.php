...
class MB_AdminOptionsPage
{
    ...
    public function start()
    {
        ...
        register_activation_hook( MB_IMPORT_EXPORT_FILE , array( $this , 'set_default_values' ) );
    }
    ...
    *  Retrieve settings_group of current tab
    ...
    protected function user_can_see_this_page()
    {
        ...
        {
            wp_die(_x('You do not have sufficient permissions to access this page.' , 'WebMapp option page capability error', 'mb' ) );
        }
    }
